...
#cmd='sbatch script/distributed_data_parallel/all_data/run_AS2S_jca0.2_ddp8_mix200_aux_x.sh  aux_oracleali_cov_drop_on_acc' 
#do_and_log $cmd
#echo $cmd submit
...
cmd='sbatch script/distributed_data_parallel/all_data/run_AS2S_jca0.2_ddp8_mix200_aux_x.sh  aux_onehot_cov' 
do_and_log $cmd
echo $cmd submit
