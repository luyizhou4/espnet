...
train_config=conf/train_alldata_large.yaml
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_lib960_mix200_discard/data.json
...
tag=ddp_all_data/AS2S_large_jca${mtlalpha}_gpu${world_size}_discard1200_50
expdir=exp/${tag}
mkdir -p ${expdir}
