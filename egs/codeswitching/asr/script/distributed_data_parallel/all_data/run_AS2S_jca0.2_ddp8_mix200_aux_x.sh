...
#train_json=/mnt/lustre/sjtu/home/jqg01/asr/e2e/cs/egs/codeswitching/asr/data/json_data/mix200_sample.json
#valid_json=/mnt/lustre/sjtu/home/jqg01/asr/e2e/cs/egs/codeswitching/asr/data/json_data/dev20_sample.json

suffix=$1

#. utils/parse_options.sh || exit 1;

preprocess_config=conf_aux_x/specaug.yaml 
train_config=conf_aux_x/train_alldata_${suffix}.yaml
decode_config=conf_aux_x/decode.yaml
tag=ddp_mix200_data/AS2S_base_jca${mtlalpha}_ddp${world_size}_mix200_${suffix}
expdir=exp_aux_x/${tag}
