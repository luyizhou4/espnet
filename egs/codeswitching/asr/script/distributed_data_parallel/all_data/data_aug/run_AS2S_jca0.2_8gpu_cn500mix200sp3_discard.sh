...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480sp_lib960_mix200sp_discard/data.json
...
tag=ddp_all_data/data_aug/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480mix200sp_discard1200_50
expdir=exp/${tag}
mkdir -p ${expdir}
