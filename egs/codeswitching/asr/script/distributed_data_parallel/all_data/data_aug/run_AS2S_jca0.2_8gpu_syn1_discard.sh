...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_lib960_mix200_m200syn1_discard/data.json
...
tag=ddp_all_data/data_aug/AS2S_base_jca${mtlalpha}_gpu${world_size}_mix200sync1_discard1200_50
expdir=exp/${tag}
mkdir -p ${expdir}
