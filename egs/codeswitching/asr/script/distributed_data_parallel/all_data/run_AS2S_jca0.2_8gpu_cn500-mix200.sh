...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-175
#SBATCH --mem=50G
#SBATCH --array=1-8
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_mix200/data.json
...
tag=ddp_all_data/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn500-mix200
expdir=exp/${tag}
mkdir -p ${expdir}
