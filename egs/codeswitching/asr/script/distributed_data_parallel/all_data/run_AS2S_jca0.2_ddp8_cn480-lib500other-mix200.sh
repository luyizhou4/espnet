...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_lib500other_mix200/data.json
...
tag=ddp_all_data/lib_percentage/AS2S_base_jca${mtlalpha}_ddp${world_size}_cn480-lib500other-mix200
expdir=exp/${tag}
mkdir -p ${expdir}
