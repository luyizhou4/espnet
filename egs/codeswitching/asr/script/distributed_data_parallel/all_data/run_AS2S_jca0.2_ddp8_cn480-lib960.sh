...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_lib960/data.json
...
tag=ddp_all_data/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960
expdir=exp/${tag}
mkdir -p ${expdir}
