...
tag=ddp_all_data/ACTC/tfbase_jca${mtlalpha}_gpu${world_size}_lib960
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${rank} -eq 0 ]; then
    ...
    if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
        ...
        (
            # split data
            dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/lib_dev/data.json
