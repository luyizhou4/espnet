...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/lib960_discard/data.json
...
tag=ddp_all_data/ACTC/tfbase_jca${mtlalpha}_gpu${ngpu}_lib960_discard1200-50_data-parallel
expdir=exp/${tag}
mkdir -p ${expdir}
