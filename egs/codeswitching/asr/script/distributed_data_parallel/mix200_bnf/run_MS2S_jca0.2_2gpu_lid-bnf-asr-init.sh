...
mtlalpha=0.2
bnf_dim=256
pretrained_jca_model=./exp/ddp/mix200_jca0.2_gpu2/results/model.last5.avg.best
epochs=15
...
tag=bnf/mix200/mix200_jca0.2_gpu2_lid-bnf-asr-init_re
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --moe-mode true \
        --bnf-dim ${bnf_dim} \
        --pretrained-jca-model ${pretrained_jca_model} \
        --epochs ${epochs} \
