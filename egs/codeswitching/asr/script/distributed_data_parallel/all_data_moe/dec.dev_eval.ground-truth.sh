...
decode_dir="dev_mix20_beam8_grd_moe"
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/hybrid_grd_trh/dev_mix20
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    cat ${expdir}/${decode_dir}/ref.word.txt | sed -e 's/\s\+/ /g' | grep -v "devnew_T0427G1838_S01010004\|devnew_T0464G2272_S01010054" | sort > ${expdir}/${decode_dir}/ref.word.final.txt
...
decode_dir="eval_mix20_beam8_grd_moe"
if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
    ...
    (
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/hybrid_grd_trh/eval_mix20
        splitjson.py --parts ${nj} ${dev_root}/data.json
