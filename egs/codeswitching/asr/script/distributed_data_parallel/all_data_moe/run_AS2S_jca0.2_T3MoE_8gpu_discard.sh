...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072
#SBATCH --mem=50G
#SBATCH --array=1-8
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/cn480_lib960_mix200_discard/data.json
...
tag=ddp_all_data/MoE/AS2S_base_jca${mtlalpha}_gpu${world_size}_moelayer${submoe_layers}_${submoe_type}_discard1200_50_re
expdir=exp/${tag}
mkdir -p ${expdir}
