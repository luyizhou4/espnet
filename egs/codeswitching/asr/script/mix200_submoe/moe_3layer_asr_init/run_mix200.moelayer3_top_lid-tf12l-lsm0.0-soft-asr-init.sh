...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/mix200/data.json
...
tag=mix200_submoe/moelayer3_asr_init/moelayer${submoe_layers}_${submoe_type}_lid-tf6l-lsm0.0-soft-asr-init
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/dev_mix20
...
if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
    ...
    (
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/eval_mix20
        splitjson.py --parts ${nj} ${dev_root}/data.json
