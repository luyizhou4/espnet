...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060,gqxx-01-059,gqxx-01-058,gqxx-01-064,gqxx-01-062,gqxx-01-174
#SBATCH --mem=50G
#SBATCH --array=1-8
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn480_lib460_mix200/data.json
...
tag=moe/mlpmoe_einit/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib460-mix200
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --model-module "espnet.nets.pytorch_backend.mlpmoe.e2e_asr_transformer_mlpmoe_einit:E2E" \
...
if [ $rank -eq 0 ]; then
    ...
    if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
        ...
        (
            # split data
            dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn500_eval20
    ...
    if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
        ...
        (
            # split data
            dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/lib_dev
            splitjson.py --parts ${nj} ${dev_root}/data.json
