...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060
#SBATCH --mem=50G
#SBATCH --array=1-8
...
tag=moe/mlme/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960
expdir=exp/${tag}
mkdir -p ${expdir}
