...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060,gqxx-01-058,gqxx-01-059
#SBATCH --mem=50G
#SBATCH --array=1-8
...
tag=moe/mlme/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960-ctcinit
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --moe-mode true \
        --model-module "espnet.nets.pytorch_backend.mlpmoe.e2e_asr_transformer_mlpmoe_mlme:E2E" \
