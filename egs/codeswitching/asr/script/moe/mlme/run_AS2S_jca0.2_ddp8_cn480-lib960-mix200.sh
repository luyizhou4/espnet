...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/cn480_lib960_mix200/data.json
...
tag=moe/mlme/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960-mix200
expdir=exp/${tag}
mkdir -p ${expdir}
