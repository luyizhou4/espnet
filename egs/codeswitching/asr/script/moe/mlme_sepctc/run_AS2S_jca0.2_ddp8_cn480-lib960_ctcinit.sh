...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060,gqxx-01-058,gqxx-01-059,gqxx-01-062,gqxx-01-008
#SBATCH --mem=50G
#SBATCH --array=1-8
...
mtlalpha=0.2
batch_bins=3750000
pretrained_cn_ctc_model=./exp/ddp_all_data/ACTC/tfbase_jca1.0_gpu4_cn500-train480/results/model.last5.avg.best
pretrained_en_ctc_model=./exp/ddp_all_data/ACTC/tfbase_jca1.0_gpu4_lib960/results/model.last5.avg.best
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/cn480_lib960/data.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/dev_mix20/data.json

tag=moe/mlme_sepctc/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960-ctcinit
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --moe-mode true \
        --model-module "espnet.nets.pytorch_backend.mlpmoe.e2e_asr_transformer_mlpmoe_mlme_sepctc:E2E" \
        --pretrained-cn-ctc-model ${pretrained_cn_ctc_model} \
        --pretrained-en-ctc-model ${pretrained_en_ctc_model} \
...
if [ $rank -eq 0 ]; then
    ...
    if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
        ...
        (
            # split data
            dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/cn500_eval20
    ...
    if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
        ref_label=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/cn500_eval20/text
    ...
    if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
        ...
        (
            # split data
            dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/lib_dev
            splitjson.py --parts ${nj} ${dev_root}/data.json
    ...
    if [ ${stage} -le 7 ] && [ ${stop_stage} -ge 7 ]; then
        ref_label=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/lib_dev/text
        vocab=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/vocab 
        ignored_tokens="0_1000_4005_4006_4007"
        # parse label and compute MER
        concatjson.py ${expdir}/${decode_dir}/data.*.json > ${expdir}/${decode_dir}/data.json
