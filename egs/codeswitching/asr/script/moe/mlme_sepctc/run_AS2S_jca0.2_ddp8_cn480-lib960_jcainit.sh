...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060,gqxx-01-059,gqxx-01-058
#SBATCH --mem=50G
#SBATCH --array=1-8
...
tag=moe/mlme_sepctc/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-lib960-jcainit
expdir=exp/${tag}
mkdir -p ${expdir}
