...
#SBATCH -c 3
#SBATCH -o logs/ddp.%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-003,gqxx-01-072,gqxx-01-071,gqxx-01-057,gqxx-01-056,gqxx-01-060,gqxx-01-059,gqxx-01-058,gqxx-01-062
#SBATCH --mem=50G
#SBATCH --array=1-4
...
mtlalpha=0.2
batch_bins=3750000
pretrained_cn_jca_model=./exp/ddp_all_data/AS2S_base_jca0.2_gpu8_cn480/results/model.last5.avg.best
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/moe_json_data/tf_12l_lsm0.0_asr_init/cn500_train480/data.json
...
tag=moe/mlme_sepctc/AS2S_base_jca${mtlalpha}_gpu${world_size}_cn480-jcainit
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --pretrained-cn-jca-model ${pretrained_cn_jca_model} \
