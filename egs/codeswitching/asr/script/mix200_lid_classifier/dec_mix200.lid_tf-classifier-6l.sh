...
tag=lid_classifier/transformer_layer${elayers}
expdir=exp/${tag}
mkdir -p ${expdir}
...
dec_tag="greedy_decoding_mix200"
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        ...
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/lang_chunk/hybrid_align_json/mix200
