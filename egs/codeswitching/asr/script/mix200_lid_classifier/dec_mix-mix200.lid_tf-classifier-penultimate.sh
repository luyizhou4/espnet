...
dec_tag="greedy_decoding_mix200-all_penultimate"
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        ...
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/lang_chunk/hybrid_align_json/mix200_dec
