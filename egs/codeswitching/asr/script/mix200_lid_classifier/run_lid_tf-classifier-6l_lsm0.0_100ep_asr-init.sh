...
#SBATCH -c 3
#SBATCH -o logs/%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-121,gqxx-01-122,gqxx-01-076,gqxx-01-003
#SBATCH --mem=50G
...
lsm_weight=0.0
epochs=100
ctc_init=./exp/mix200_baseline/jca1.0_layer6_gpu1/results/model.last5.avg.best
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/lang_chunk/hybrid_align_json/mix200/data.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/lang_chunk/hybrid_align_json/dev_mix20/data.json

tag=lid_classifier/transformer_layer${elayers}_lsm${lsm_weight}_ep${epochs}_asr_pretrained
expdir=exp/${tag}
mkdir -p ${expdir}
