...
tag=mix200_lid_mtl/decoder_lid_mtl0.1
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --model-module "espnet.nets.pytorch_backend.e2e_asr_transformer_lid:E2E" \
        --log-lid-mtl-acc true \
        --train-json ${train_json} \
        --valid-json ${valid_json}
fi


dec_tag="dev_mix20_beam8_penultimate"
