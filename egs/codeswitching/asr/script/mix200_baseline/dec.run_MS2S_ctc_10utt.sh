...
ctc_greedy_decoding=true
beam_size=1
dec_tag="dev_mix20_beam${beam_size}_greedy${ctc_greedy_decoding}_10utt"
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        ...
        # split data
        dev_root=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_10utt
        ...
        run.pl JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
            ...
            --beam-size ${beam_size} \
            --ctc-greedy-decoding ${ctc_greedy_decoding} \
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ref_label=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_10utt/text
