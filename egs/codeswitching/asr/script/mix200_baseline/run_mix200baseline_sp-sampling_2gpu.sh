...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/mix200sp/data.json
...
tag=mix200_baseline/transformer_base_sp-sampling_2gpu
expdir=exp/${tag}
mkdir -p ${expdir}
