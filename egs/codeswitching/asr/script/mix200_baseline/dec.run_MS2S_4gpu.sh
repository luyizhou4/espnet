...
#SBATCH -c 3
#SBATCH -o logs/%j
#SBATCH -x gqxx-01-075,gqxx-01-054,gqxx-01-036,gqxx-00-005,gqxx-01-027,gqxx-01-026,gqxx-01-016,gqxx-00-002
#SBATCH --mem=50G
...
tag=mix200_baseline/transformer_base_4gpu
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    decode_dir=decode_${dec_tag}_decode
