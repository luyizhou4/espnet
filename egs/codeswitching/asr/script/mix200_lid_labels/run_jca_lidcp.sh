...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/mix200_lid/data_lidcp.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_lid/data_lidcp.json

tag=mix200_lid_labels/lid_change-point
expdir=exp/${tag}
mkdir -p ${expdir}
