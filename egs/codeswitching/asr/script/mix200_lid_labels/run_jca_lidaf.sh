...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/mix200_lid/data_lidaf.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_lid/data_lidaf.json

tag=mix200_lid_labels/lid_after
expdir=exp/${tag}
mkdir -p ${expdir}
