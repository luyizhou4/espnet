...
#SBATCH -c 6
#SBATCH -o logs/%j
#SBATCH -x gqxx-01-075,gqxx-01-014
#SBATCH --mem=50G
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/mix200_lid/data_lidbf.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_lid/data_lidbf.json

tag=mix200_lid_labels/lid_before
expdir=exp/${tag}
mkdir -p ${expdir}
