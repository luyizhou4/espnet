...
#SBATCH -c 3
#SBATCH -o logs/%j
#SBATCH -x gqxx-01-075,gqxx-01-014,gqxx-01-011
#SBATCH --mem=50G
...
train_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/mix200_lid/data.json
valid_json=/mnt/lustre/sjtu/users/yzl23/work_dir/asr/is20_codeswitching/espnet/egs/codeswitching/asr/data/json_data/dev_mix20_lid/data.json

tag=mix200_lid_labels/jca_baseline
expdir=exp/${tag}
mkdir -p ${expdir}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    (
        ...
        slurm.pl JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
            ...
            --store-penultimate-state "ark:| copy-feats ark:- ark,scp:${expdir}/${decode_dir}/penultimate.JOB.ark,${expdir}/${decode_dir}/penultimate.JOB.scp" \
