...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        hs_pad, hs_mask = self.additional_encoder_layer(hs_pad, hs_mask)
        hs_pad = self.additional_after_norm(hs_pad)
        self.hs_pad = hs_pad
    ...
    def encode(self, x):
        ...
        enc_output, _ = self.additional_encoder_layer(enc_output, None)
        enc_output = self.additional_after_norm(enc_output)
