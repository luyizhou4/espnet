...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        # frozen params
        group.add_argument('--activated-keys', default='', type=str,
                         help='activated network parameter keys for grad, \
                         options: encoder, src_att, decoder, ctc\
                         keys are seperated by space')
        return parser
