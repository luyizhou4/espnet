...
from espnet.nets.pytorch_backend.transformer.encoder_aux_emb import Encoder
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        group.add_argument('--aux-model-path', default=None, required=True, type=str,
                           help='auxiliary model path')
        group.add_argument('--aux-pos', default='COVOUT', type=str,
		                   help='position where auxiliry bottleneck concatenate: COVOUT, ENOUT')
        group.add_argument('--onehot', default=False, type=strtobool,
		                   help='use onehot as emb')
        group.add_argument('--preprocess_conf', default=None, type=str,
		                   help='precoess_conf')
        return parser
