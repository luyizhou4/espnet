...
from espnet.nets.pytorch_backend.transformer.submoe.moe_encoder import Encoder
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        # yzl23 moe-related
        group.add_argument('--submoe-type', default="bottom", type=str,
                            choices=["bottom", "top"],
                           help='submoe on bottom/top of encoder')
        group.add_argument('--submoe-layers', default=3, type=int,
                           help='number of layers in each seperate experts')
        group.add_argument('--fake-moe', default=False, type=strtobool,
                           help='fake moe, simply average over cn_xs & en_xs')
        return parser
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.encoder = Encoder(
            ...
            submoe_type=args.submoe_type,
            num_blocks_moe=args.submoe_layers,
            fake_moe=args.fake_moe
        )
    ...
    def forward(self, xs_pad, ilens, ys_pad, moe_coes, moe_coe_lens):
        ...
        hs_pad, hs_mask = self.encoder(xs_pad, src_mask, moe_coes)
        self.hs_pad = hs_pad
    ...
    def encode(self, x):
        ...
        enc_output, _ = self.encoder(x, None, moe_coe)
