...
def get_parser():
    ...
    parser.add_argument('--model-enc', type=str, required=True,
                        help='Model-enc file parameters to read')
    parser.add_argument('--model-aux', type=str, required=True,
                        help='Model-aux file parameters to read')
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.asr.pytorch_backend.asr_ocl_enc_emb_onehot import recog
