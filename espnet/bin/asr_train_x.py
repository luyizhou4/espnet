...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument('--do-preprocess', type=strtobool, default=True,
                        help='do the pre-processing in dataloader')
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr_aux_x import train
            train(args)
        else:
